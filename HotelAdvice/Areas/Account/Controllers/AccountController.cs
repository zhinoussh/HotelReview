...
namespace HotelAdvice.Areas.Account.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            return PartialView("_PartialRegisterModal");
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email,FirstName=model.fname
            ...
            return PartialView("_PartialRegisterModal",model);
        }
